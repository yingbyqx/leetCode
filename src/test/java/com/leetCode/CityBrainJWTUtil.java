...
public class CityBrainJWTUtil {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * tenantName 租户名
         */
        String issuer = "{\"accountId\":\"\",\"lastName\":\"\"," +
                "\"clientId\":\"\",\"realmId\":\"\"," +
                "\"tenantName\":\"\",\"realmName\":\"\",\"namespace\":\"\"," +
                "\"tenantId\":\"\",\"nickNameCn\":\"周国宏\"," +
                "\"tenantUserId\":\"\",\"account\":\"screen\"}";
        Map<String, Object> userInfo = JSONUtil.parseObj(issuer);
        //模拟生成Authorization
        String Authorization = createJWT(appSecret, "周国宏", appSecret, issuer);
...
//        Thread.sleep(6000);
        ...
        System.out.println("大屏系统登录的用户姓名：" + resMap.get("username"));
        System.out.println("大屏系统登录的用户名信息：" + resMap.get("issuer"));
